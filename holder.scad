...
difference() {
    translate([-16, 2-h/2, -15]) cube([30, h, boom_size+boom_element_center_distance+element_diameter+3]);
    ...
    translate([10.5, h/2-1.5, 0]) cylinder(100, d=3.3, center=true);
    translate([10.5, h/2-1.5, -16]) cylinder(1+2.45, d=6.6, $fn=6);
    translate([-2, 11.5, element_diameter/2+boom_element_center_distance+6]) rotate([90, 0, 0]) cylinder(100, d=2, center=true);
    ...
    translate([-1.5, -1.5, -15+.5]) rotate([180, 0, 0]) linear_extrude(height=1) {
